package com.sinotech.view.form.core;

import android.graphics.Paint;

import com.sinotech.view.form.data.CellInfo;
import com.sinotech.view.form.data.column.Column;
import com.sinotech.view.form.data.format.bg.IBackgroundFormat;
import com.sinotech.view.form.data.format.bg.ICellBackgroundFormat;
import com.sinotech.view.form.data.format.draw.LeftTopDrawFormat;
import com.sinotech.view.form.data.format.grid.IGridFormat;
import com.sinotech.view.form.data.format.grid.SimpleGridFormat;
import com.sinotech.view.form.data.format.sequence.ISequenceFormat;
import com.sinotech.view.form.data.style.FontStyle;
import com.sinotech.view.form.data.style.LineStyle;
...
public class TableConfig {
    ...
    public TableConfig setYSequenceFormat(ISequenceFormat ySequenceFormat) {

...
public class ParamTableData extends TableData<Object> {
     ...
     * @param mapList   Map数组
     */
    public static ParamTableData create(String tableName, List<Object> mapList) {
        return create(tableName, mapList, null,null);
    }

    public static ParamTableData create(String tableName, List<Object> mapList,List<String> params) {
        return create(tableName, mapList, null,params);
    }

    public static ParamTableData create(String tableName, List<Object> mapList, IFormat<String> keyFormat,List<String> params) {
        if (mapList != null) {
            List<Column> columns = new ArrayList<>();
            getParamMapColumn(columns, Column.INVAL_VALUE, Column.INVAL_VALUE, mapList, keyFormat, params);
            return new ParamTableData(tableName, mapList, columns);
        }
        return null;
    }
     ...
     */
    private static void getParamMapColumn(List<Column> columns, String fieldName, String parentKey, List<Object> mapList, IFormat<String> keyFormat,List<String> params) {
                    ...
                    for (Map.Entry<String, Object> entry : map.entrySet()) {
                        ...
                        if (ArrayColumn.isList(val)) {
                            if (isOneArray) {
                                ...
                                getParamMapColumn(columns, fieldName + key + ".", key, list, keyFormat, params);
                                isOneArray = false;
                            }
                        } else {
    ...
    private ParamTableData(String tableName, List t, List<Column> columns) {

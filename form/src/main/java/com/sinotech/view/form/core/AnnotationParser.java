...
import com.sinotech.view.form.annotation.ColumnType;
...
public class AnnotationParser<T>  {
    ...
    public PageTableData<T> parse(List<T> dataList){
        if(dataList!= null && dataList.size() >0) {
            ...
            if(firstData != null) {
                ...
                Annotation tableAnnotation = clazz.getAnnotation(com.sinotech.view.form.annotation.SmartTable.class);
                if(tableAnnotation != null){
                    com.sinotech.view.form.annotation.SmartTable table = (com.sinotech.view.form.annotation.SmartTable) tableAnnotation;
    ...
    private void createColumn(String fieldName, Field field, List<Column> columns, Map<String, Column> parentMap, boolean isArray, boolean isThoroughArray, SmartColumn smartColumn) {
        ...
        String bottomName = smartColumn.autoBottomName();
        ...
        column.setBottomName(bottomName);

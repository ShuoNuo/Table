package com.sinotech.view.form.component;
...
import com.sinotech.view.form.data.format.selected.IDrawOver;
import com.sinotech.view.form.data.format.selected.ISelectFormat;
import com.sinotech.view.form.data.format.tip.ITip;
import com.sinotech.view.form.data.table.TableData;
import com.sinotech.view.form.listener.OnColumnClickListener;
import com.sinotech.view.form.listener.TableClickObserver;
import com.sinotech.view.form.utils.DrawUtils;
        ...
        if (tableData.isShowCount()) {
            ...
            if (DrawUtils.isVerticalMixRect(showRect, (int)top, (int)bottom)) {
                ...
                for (int i = 0; i < columnSize; i++) {
                    ...
                    drawCountText(canvas, column,i,tempRect,
                            TextUtils.isEmpty(column.getBottomName()) ?
                                    (TextUtils.isEmpty(column.getTotalDatas()) ? column.getTotalNumString() :column.getTotalDatas())
                                    : column.getBottomName() , config);
                    left = tempLeft;
                    left +=width;
                }

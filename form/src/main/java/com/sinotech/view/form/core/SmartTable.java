...
import com.sinotech.view.form.component.ITableTitle;
import com.sinotech.view.form.component.TableProvider;
import com.sinotech.view.form.component.TableTitle;
import com.sinotech.view.form.component.XSequence;
import com.sinotech.view.form.component.YSequence;
...
import com.sinotech.view.form.listener.OnTableChangeListener;
import com.sinotech.view.form.matrix.MatrixHelper;
...
public class SmartTable<T> extends View implements OnTableChangeListener {
     ...
     * @param data 表格数据
     */
    public PageTableData<T> setData(List<T> data,T totalDate) {
        if (annotationParser == null) {
            annotationParser = new AnnotationParser<>(config.dp10);
        }
        PageTableData<T> tableData = annotationParser.parse(data);
    ...
    public void notifyDataChanged() {
        ...
        if (tableData != null) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    if (totalDate != null){
                        parser.parse(tableData,totalDate);
                    }else {
